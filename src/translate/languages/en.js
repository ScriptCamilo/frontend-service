  ...
  en: {
    translations: {
      ...
      noticeModal: {
        ...
        toasts: {
          allSuccess: "All customers were notified successfully.",
          someSuccess: "Some customers were notified successfully.",
          deleted: "Notice deleted successfully.",
          edited: "Notice updated successfully."
        },
        confirmationModal: {
          deleteTitle: "Are you sure you want to delete this notice?",
          deleteMessage: "This action cannot be undone.",
        },
        severity: {
          error: "Error",
      ...
      selectConnection: {
        whatsapp: {
          label: "Select a WhatsApp",
          firstItem: "No WhatsApp",
          empty: "No WhatsApp assigned to attendant"
        },
        facebook: {
          label: "Select a Facebook",
          firstItem: "No Facebook",
          empty: "No Facebook assigned to attendant"
        },
        instagram: {
          label: "Select an Instagram",
          firstItem: "No Instagram",
          empty: "No Instagram assigned to attendant"
        },
      },
      queueModal: {
        title: {
      ...
      schedules: {
        ...
        toasts: {
          ...
          sendNow: "Scheduled message sent successfully.",
        },
        searchPlaceholder: "Search...",
        confirmationModal: {
      ...
      backendErrors: {
        ...
        ERR_APP_NOT_ENABLE: "App module not included in the plan. Please contact support.",
