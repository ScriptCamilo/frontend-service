const messages = {
  es: {
    translations: {
      ...
      noticeModal: {
        title: {
          notice: "Creación de ventanas emergentes",
        },
        form: {
          message: "Mensaje",
        ...
        success: "Clientes notificados satisfactoriamente.",
      },
      quickAnswersModal: {
        title: {
      ...
      scheduleModal: {
        title: {
          ...
          copy: "Copiar mensaje programado",
        },
        form: {
          message: "Mensaje",
        },
      ...
      schedules: {
        ...
        toasts: {
          ...
          sendNow: "Mensaje programado enviado con éxito.",
        },
        searchPlaceholder: "Buscar...",
        confirmationModal: {
